...
from models.DVM_base import CustomCIFAR100
...
def validate(val_loader, model, criterion, epoch, args, log=None, tf_writer=None, flag='val'):
    ...
    with torch.no_grad():
        ...
        head_classes = sorted_indices[:num_classes // 3]  # Top 1/3
        middle_classes = sorted_indices[num_classes // 3:2 * num_classes // 3]  # Middle 1/3
        tail_classes = sorted_indices[2 * num_classes // 3:]  # Bottom 1/3
