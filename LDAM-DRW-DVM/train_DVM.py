...
from DVM.DVM import CustomCIFAR10,CustomCIFAR100
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if args.dataset == 'cifar10':
        train_dataset = CustomCIFAR10(root='/root/autodl-tmp/cifar10_200/autodl-tmp/diffuseMix-main/cifar10-200-2p', transform=transform_train)
        val_dataset = datasets.CIFAR10(root='./data', train=False, download=True, transform=transform_val)
    elif args.dataset == 'cifar100':
        train_dataset = CustomCIFAR100(root='/root/autodl-tmp/cifar10/cifar10_100_2p', transform=transform_train)
